...
def cfg():
    ...
    model_config = {"musdb_path" : "/content/root/", # SET MUSDB PATH HERE, AND SET CCMIXTER PATH IN CCMixter.xml
                    ...
                    'cache_size': 2500, # Number of audio snippets buffered in the random shuffle queue. Larger is better, since workers put multiple examples of one song into this queue. The number of different songs that is sampled from with each batch equals cache_size / num_snippets_per_track. Set as high as your RAM allows.
